var gameProperties = {
    screenWidth: 640, //Valor Variable Modificable
    screenHeight: 480, //Valor Variable Modificable
	
    delayToStartLevel: 3, //Valor Variable Modificable
    padding: 30, //Valor Variable Modificable
};
...
var graphicAssets = {
    ship:{URL:'assets/ship.png', name:'ship'}, //Valors Variables Modificables
    bullet:{URL:'assets/bullet.png', name:'bullet'}, //Valors Variables Modificables    
    
    asteroidLarge:{URL:'assets/asteroidLarge.png', name:'asteroidLarge'}, //Valors Variables Modificables
    asteroidMedium:{URL:'assets/asteroidMedium.png', name:'asteroidMedium'}, //Valors Variables Modificables
    asteroidSmall:{URL:'assets/asteroidSmall.png', name:'asteroidSmall'}, //Valors Variables Modificables
	
    background:{URL:'assets/background.png', name:'background'},
    explosionLarge:{URL:'assets/explosionLarge.png', name:'explosionLarge', width:64, height:64, frames:8}, //Valors Variables Modificables
    explosionMedium:{URL:'assets/explosionMedium.png', name:'explosionMedium', width:58, height:58, frames:8}, //Valors Variables Modificables
    explosionSmall:{URL:'assets/explosionSmall.png', name:'explosionSmall', width:41, height:41, frames:8}, //Valors Variables Modificables
};

var soundAssets = {
    fire:{URL:['assets/fire.m4a', 'assets/fire.ogg'], name:'fire'}, //Valors Variables Modificables
    destroyed:{URL:['assets/destroyed.m4a', 'assets/destroyed.ogg'], name:'destroyed'}, //Valors Variables Modificables
};
...
var shipProperties = {
    ...
    startingLives: 3, //Valor Variable Modificable
    timeToReset: 3, //Valor Variable Modificable
    blinkDelay: 0.2, //Valor Variable Modificable
};
...
var asteroidProperties = {
    startingAsteroids: 4, //Valor Variable Modificable
    maxAsteroids: 20, //Valor Variable Modificable
    incrementAsteroids: 2, //Valor Variable Modificable
