...
var graphicAssets = {
    ship:{URL:'assets/ships/ship3.png', name:'ship'}, //Valors Variables Modificables
    bullet:{URL:'assets/bullets/bullet.png', name:'bullet'}, //Valors Variables Modificables    
    
    asteroidLarge:{URL:'assets/Large_Asteroids/asteroidLarge3.png', name:'asteroidLarge'}, //Valors Variables Modificables
    asteroidMedium:{URL:'assets/Medium_Asteroids/asteroidMedium3.png', name:'asteroidMedium'}, //Valors Variables Modificables
    asteroidSmall:{URL:'assets/Small_Asteroids/asteroidSmall3.png', name:'asteroidSmall'}, //Valors Variables Modificables
	
    background:{URL:'assets/backgrounds/background19.jpg', name:'background'},
    explosionLarge:{URL:'assets/Explosions/explosionLarge.png', name:'explosionLarge', width:64, height:64, frames:8}, //Valors Variables Modificables
    explosionMedium:{URL:'assets/Explosions/explosionMedium.png', name:'explosionMedium', width:58, height:58, frames:8}, //Valors Variables Modificables
    explosionSmall:{URL:'assets/Explosions/explosionSmall.png', name:'explosionSmall', width:41, height:41, frames:8}, //Valors Variables Modificables
};
